...
# ==========================================
# PAGE 2: VISUALIZATION (UPDATED WITH SAFETY CHECK)
# ==========================================
    ...
    # --- CƠ CHẾ PHÒNG VỆ: Kiểm tra nếu dữ liệu trống ---
    if df_filtered.empty:
        st.warning("⚠️ Vui lòng chọn ít nhất một Năm học (Year of Study) và một Giới tính (Gender) ở thanh công cụ bên trái để xem dữ liệu.")
    else:
